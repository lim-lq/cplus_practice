...
HelloClient::HelloClient() : Ice::Application(Ice::NoSignalHandling)
{
}
...
int HelloClient::run(int argc, char* argv[])
{
    ...
    HelloPrx twoway = HelloPrx::checkedCast(communicator()->propertyToProxy("Hello.Proxy")->ice_twoway()->ice_timeout(-1)->ice_secure(false));
    if ( !twoway ) {
